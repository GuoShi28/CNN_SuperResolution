...
%Block 3
%Change 4: model 1 -> model 2 2016\11\21
% net.layers{end+1} = struct('type', 'conv', ...
...
%                            'weightDecay', zeros(1, 2, 'single')) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.001*randn(5,5,filters_num2,filters_num2, 'single'), zeros(1,filters_num2,'single')}}, ...
                           'weights_depth', {{0.001*randn(5,5,filters_num2,filters_num2, 'single'), zeros(1,filters_num2,'single')}}, ...
                           'stride', 1, ...
                           'pad', 2, ...
                           'stride_depth', 1, ...
                           'pad_depth', 2, ...
...
%                            'weightDecay', zeros(1, 2, 'single')) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.1*randn(9,9,filters_num2*2,filters_num3, 'single'), zeros(1, filters_num3, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 2, ...
                           'learningRate', 1e-4 * ones(1, 2, 'single'), ...
                           'weightDecay', zeros(1, 2, 'single')) ;
